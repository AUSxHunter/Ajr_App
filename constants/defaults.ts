...
export const DEFAULT_IBADAH_TYPES: Omit<IbadahType, 'createdAt' | 'updatedAt'>[] = [
  ...
  },
  {
    ...
    unit: 'adhkar',
    icon: 'sun',
    color: DarkColors.ibadah.adhkar,
    weight: 5,
    isDefault: true,
    isArchived: false,
    sortOrder: 1,
  ...
  },
  {
    ...
    unit: 'currency',
    icon: 'gift',
    color: DarkColors.ibadah.sadaqah,
    weight: 8,
    isDefault: true,
    isArchived: false,
    sortOrder: 2,
  ...
  },
  {
    ...
    unit: 'yesno',
    icon: 'sunrise',
    color: DarkColors.ibadah.fasting,
    weight: 60,
    isDefault: true,
    isArchived: false,
    sortOrder: 3,
